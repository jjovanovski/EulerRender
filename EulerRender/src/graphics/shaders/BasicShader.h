...
"	"
"	if(useNormalMap > 0) {"
"		fragmentNormalUnit = normalize(mat3(normalize(fragmentTangent), normalize(fragmentBitangent), fragmentNormalUnit) * normalize(vec3(texture(normalTex, uvPos)) * 2.0 - 1.0));"
"	}"
"	"
